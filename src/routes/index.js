...
import orgKycRoutes from './orgKyc.routes.js';
...
router.use('/org', orgKycRoutes);
router.use('/upload', uploadRoutes);
router.use('/admin', adminRoutes);
router.use('/sites', siteRoutes);
router.use('/farmers', farmerRoutes);
router.use('/land-acquisitions', landAcquisitionRoutes);
router.use('/property-lifecycle', propertyLifecycleRoutes);
...
router.use('/rera', reraFoundationRoutes);
